...
news_input.grid(row=1, column=0, padx=5, pady=5)
...
news_output.grid(row=4, column=0, padx=10, pady=5, sticky='nw')
...
url_input.grid(row=1, column=0, padx=5, pady=5, columnspan=2)
...
url_output.grid(row=6, column=0, padx=5, pady=5, sticky="nw")
